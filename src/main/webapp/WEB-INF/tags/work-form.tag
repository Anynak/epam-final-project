...
<c:if test="${empty work}">
    <div class="mb-3">
        ...
        <label for="numberOfSpecialists" class="form-label">Number of required specialists</label>
...
<c:if test="${not empty work}">
    <div class="mb-3">
        <label for="description1" class="form-label">Work description</label>
        <textarea name="workDescription" class="form-control" required id="description1" rows="3">${work.description}</textarea>

        <label for="numberOfSpecialists1" class="form-label">Number of required specialists</label>
        ...
        <label for="qualification1" class="form-label">required qualification</label>
